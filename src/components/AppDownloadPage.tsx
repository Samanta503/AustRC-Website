...
const PhoneMockup = () => {
  ...
  return (
    ...
    >
      ...
      {/* Phone Frame */}
      <div className="relative w-64 h-[520px] bg-gradient-to-b from-gray-800 via-gray-900 to-gray-800 rounded-[3rem] p-2 shadow-[0_0_80px_0_rgba(46,204,113,0.3),inset_0_0_20px_0_rgba(255,255,255,0.05)]">
        {/* Phone Inner Frame */}
        <div className="relative w-full h-full bg-black rounded-[2.5rem] overflow-hidden">
          {/* Dynamic Island */}
          <motion.div 
            className="absolute top-3 left-1/2 -translate-x-1/2 w-24 h-7 bg-black rounded-full z-20 flex items-center justify-center gap-2"
          ...
          {/* App Screen Content */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0a] to-black pt-14">
            {/* App Header */}
            <div className="px-5 py-4">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <motion.div 
                    className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#2ECC71] to-[#27AE60] flex items-center justify-center"
                  ...
                  <div>
                    <span className="text-white text-sm font-semibold block">AUSTRC</span>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                {[
                  ...
                  >
                    <stat.icon className="w-4 h-4 text-[#2ECC71] mb-1" />
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-[#2ECC71]/20 to-[#27AE60]/10 rounded-xl p-3 border border-[#2ECC71]/30"
              >
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-[#2ECC71] text-xs font-medium">UPCOMING</span>
                    <p className="text-white text-sm font-medium mt-1">Robo Workshop</p>
                    <p className="text-gray-400 text-xs">Tomorrow, 3:00 PM</p>
                  </div>
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                    className="w-8 h-8 bg-[#2ECC71] rounded-full flex items-center justify-center"
                  >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4">
              <div className="bg-gray-900/90 backdrop-blur rounded-2xl p-3 flex justify-around border border-gray-800">
                {[Cpu, Calendar, MessageSquare, Users].map((Icon, i) => (
                  <motion.div
                    key={i}
                    className={`p-2 rounded-xl ${i === 0 ? 'bg-[#2ECC71]/20' : ''}`}
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <Icon className={`w-5 h-5 ${i === 0 ? 'text-[#2ECC71]' : 'text-gray-500'}`} />
                  </motion.div>
                ))}
              </div>
            </div>
    ...
    <main ref={containerRef} className="relative min-h-screen bg-black overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 pt-24 pb-20">
        ...
        <motion.section
          ...
          className="min-h-[90vh] flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20"
        >
          {/* Left Content */}
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            ...
            >
              <Button
                ...
                className="group relative w-full sm:w-auto px-8 py-7 text-lg font-semibold bg-gradient-to-r from-[#2ECC71] to-[#27AE60] hover:from-[#27AE60] hover:to-[#2ECC71] text-white rounded-2xl shadow-[0_0_40px_0_rgba(46,204,113,0.4)] hover:shadow-[0_0_60px_0_rgba(46,204,113,0.6)] transition-all duration-500 overflow-hidden"
              >
                {isDownloading ? (
                  <div className="flex items-center gap-3">
                    <motion.div
        ...
        >
          ...
          >
            <span className="text-[#2ECC71] text-sm font-semibold tracking-wider uppercase">Features</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl p-8 rounded-3xl border border-gray-800/50 group-hover:border-[#2ECC71]/30 transition-all duration-500 h-full">
                  <motion.div
                    whileHover={{ rotate: 360, scale: 1.1 }}
                    transition={{ duration: 0.6 }}
                    className={`w-14 h-14 bg-gradient-to-br ${feature.iconBg} rounded-2xl flex items-center justify-center text-white mb-6 shadow-lg`}
                  >
                    {feature.icon}
                  </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                <motion.div
                  ...
                  className="mb-10"
                >
                  <span className="text-[#2ECC71] text-sm font-semibold tracking-wider uppercase">Benefits</span>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-3">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {benefits.map((benefit, index) => (
                    <motion.div
                      ...
                      whileHover={{ x: 10 }}
                      className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-gray-900/50 transition-all duration-300"
                    >
                      <motion.div
                        whileHover={{ scale: 1.1 }}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#2ECC71]/20 to-transparent rounded-3xl blur-3xl" />
                <div className="relative bg-gradient-to-b from-gray-900/80 to-black/80 backdrop-blur-xl p-8 sm:p-12 rounded-3xl border border-gray-800/50">
                  {/* App Store Rating */}
                  <div className="flex items-center gap-4 mb-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#2ECC71] to-[#27AE60] rounded-2xl flex items-center justify-center">
                      <img 
                    ...
                    <div>
                      <h3 className="text-white font-bold text-xl">AUSTRC App</h3>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              <span className="text-[#2ECC71] text-sm font-semibold tracking-wider uppercase">Guide</span>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mt-3">
            ...
            <div className="relative">
              {/* Connection Line */}
              <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#2ECC71] via-[#2ECC71]/50 to-transparent hidden md:block" />
                ...
                {[
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="relative z-10 w-16 h-16 bg-gradient-to-br from-[#2ECC71] to-[#27AE60] rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-[0_0_30px_0_rgba(46,204,113,0.4)] flex-shrink-0"
                    >
                      {item.step}
                    </motion.div>

                    {/* Content */}
                    <div className="flex-1 bg-gradient-to-r from-gray-900/80 to-black/40 backdrop-blur-sm p-6 rounded-2xl border border-gray-800/50 hover:border-[#2ECC71]/30 transition-all duration-300">
            ...
            <motion.div
              ...
              className="mt-12 p-6 bg-[#2ECC71]/5 border border-[#2ECC71]/20 rounded-2xl"
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-2">100% Safe & Secure</h3>
        ...
        >
          ...
          >
            {/* Background Glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#2ECC71]/20 via-transparent to-[#27AE60]/20 rounded-3xl blur-3xl" />
            
            <div className="relative bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl p-10 sm:p-16 rounded-3xl border border-[#2ECC71]/30 text-center overflow-hidden">
              {/* Decorative Elements */}
              <motion.div
                animate={{ rotate: 360 }}
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#2ECC71] to-[#27AE60] rounded-3xl blur-xl opacity-50" />
                <div className="relative w-full h-full bg-gradient-to-br from-[#2ECC71] to-[#27AE60] rounded-3xl flex items-center justify-center shadow-[0_0_60px_0_rgba(46,204,113,0.4)]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  onClick={handleDownload}
                  className="px-10 py-6 text-lg font-semibold bg-gradient-to-r from-[#2ECC71] to-[#27AE60] hover:from-[#27AE60] hover:to-[#2ECC71] text-white rounded-xl shadow-[0_0_40px_0_rgba(46,204,113,0.4)] transition-all duration-300"
                >
                  <Download className="w-5 h-5 mr-2" />
                  Download Now
                </Button>
                <Button
                  ...
                  variant="outline"
                  className="px-10 py-6 text-lg font-semibold border-gray-700 hover:border-[#2ECC71] text-white hover:bg-[#2ECC71]/10 rounded-xl transition-all duration-300"
                >
                  {copied ? (
                    <>
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={() => setShowModal(false)}
                className="absolute top-4 right-4 w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:text-white hover:bg-gray-700 transition-all duration-300"
              >
                <X className="w-5 h-5" />
              </motion.button>
              ...
              <div className="text-center">
                ...
                <motion.div
                  ...
                  className="w-20 h-20 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-full flex items-center justify-center mx-auto mb-6 border border-amber-500/30"
                >
